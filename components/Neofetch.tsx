...
function InfoLine({
  ...
  const labelColor =
    color === "orange" ? "text-[#E95420]" : "text-terminal-success";
  return (
    <div className="flex gap-2">
      <span className={`${labelColor} font-bold min-w-26`}>{label}:</span>
